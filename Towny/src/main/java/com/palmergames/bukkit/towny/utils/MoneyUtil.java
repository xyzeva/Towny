...
public class MoneyUtil {
	...
	public static void townWithdraw(Player player, Resident resident, Town town, int amount) {
		...
		try {
			...
			Transaction transaction = new Transaction(TransactionType.WITHDRAW, town.getAccount(), resident.getAccount(), amount);
	...
	public static void townDeposit(Player player, Resident resident, Town town, Nation nation, int amount) {
		...
		try {
			...
			Transaction transaction = new Transaction(TransactionType.DEPOSIT, resident.getAccount(), town.getAccount(), amount);
	...
	public static void nationWithdraw(Player player, Resident resident, Nation nation, int amount) {
		...
		try {
			...
			Transaction transaction = new Transaction(TransactionType.WITHDRAW, nation.getAccount(), resident.getAccount(), amount);
	...
	public static void nationDeposit(Player player, Resident resident, Nation nation, int amount) {
		...
		try {
			...
			Transaction transaction = new Transaction(TransactionType.DEPOSIT, resident.getAccount(), nation.getAccount(), amount);
